...
class RiskProfileCreate(BaseModel):
    ...
    max_total_open_risk_percent: Decimal = Field(default=Decimal("5.0"), gt=0, le=Decimal("100"))
    max_daily_loss_percent: Decimal = Field(default=Decimal("3.0"), ge=0, le=Decimal("50"))
    max_daily_profit_percent: Decimal = Field(default=Decimal("0"), ge=0, le=Decimal("100"))
