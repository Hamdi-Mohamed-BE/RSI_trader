...
powershell -NoProfile -ExecutionPolicy Bypass -Command ^
  ...
  "$patterns = @('*-m app.automation*','*-m app.orb_bot*','*-m app.challenge_20pip*','*-m app.strategy_bot_worker*','*sniper_entry_bot.py*--loop*','*run_automation.bat*','*run_lta_bot.bat*','*run_orb_bot.bat*','*run_20pip_bot.bat*','*run_20pip_challenge.bat*','*run_grid_bot.bat*','*run_trend_bot.bat*','*run_mean_reversion_bot.bat*','*run_dca_bot.bat*','*run_news_bot.bat*','*run_arbitrage_bot.bat*','*run_sniper_bot.bat*');" ^
  "$stopped = @();" ^
