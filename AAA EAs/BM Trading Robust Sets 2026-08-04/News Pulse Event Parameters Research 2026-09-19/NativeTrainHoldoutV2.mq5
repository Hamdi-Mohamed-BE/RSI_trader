...
if(kind=="NFP") {InpPlacementLeadSeconds=120;NPX_Anchor=0;InpEntryOffsetPrice=8.0;InpStopLossPrice=2.0;NPX_TPR=7.5;InpTrailStartR=1.5;InpTrailDistancePrice=6.0;InpForceCloseSecondsAfterEvent=300;}
if(kind=="CPI") {InpPlacementLeadSeconds=30;NPX_Anchor=2;InpEntryOffsetPrice=1.0;InpStopLossPrice=2.0;NPX_TPR=8.0;InpTrailStartR=100000;InpTrailDistancePrice=8.0;InpForceCloseSecondsAfterEvent=600;}
if(kind=="FOMC") {InpPlacementLeadSeconds=5;NPX_Anchor=1;InpEntryOffsetPrice=2.0;InpStopLossPrice=2.0;NPX_TPR=8.0;InpTrailStartR=2.0;InpTrailDistancePrice=2.0;InpForceCloseSecondsAfterEvent=120;}
}
