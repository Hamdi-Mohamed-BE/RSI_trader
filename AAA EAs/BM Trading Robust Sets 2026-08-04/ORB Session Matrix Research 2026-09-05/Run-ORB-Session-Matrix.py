...
CONFIGS = TESTER / "backtest-configs" / "orb-session-matrix-20260905"
TESTER_REPORTS = TESTER / "reports" / "orb-session-matrix-20260905"
...
ToDate={end}
ForwardMode=0
Report=reports\\orb-session-matrix-20260905\\{case_id}.htm
ReplaceReport=1
ShutdownTerminal=1
UseCloud=0
Visual=0
