...
if(kind=="NFP") {InpPlacementLeadSeconds=15;NPX_Anchor=0;InpEntryOffsetPrice=0.1200000000;InpStopLossPrice=0.0200000000;NPX_TPR=0.0;InpTrailStartR=100000;InpTrailDistancePrice=0.0600000000;InpForceCloseSecondsAfterEvent=60;}
if(kind=="CPI") {InpPlacementLeadSeconds=10;NPX_Anchor=2;InpEntryOffsetPrice=0.0200000000;InpStopLossPrice=0.0200000000;NPX_TPR=0.0;InpTrailStartR=100000;InpTrailDistancePrice=0.0600000000;InpForceCloseSecondsAfterEvent=60;}
if(kind=="FOMC") {InpPlacementLeadSeconds=120;NPX_Anchor=2;InpEntryOffsetPrice=0.1200000000;InpStopLossPrice=0.0200000000;NPX_TPR=0.0;InpTrailStartR=0.5;InpTrailDistancePrice=0.4000000000;InpForceCloseSecondsAfterEvent=60;}
}
