...
if(kind=="NFP") {InpPlacementLeadSeconds=15;NPX_Anchor=0;InpEntryOffsetPrice=25.0000000000;InpStopLossPrice=37.5000000000;NPX_TPR=7.5;InpTrailStartR=2.0;InpTrailDistancePrice=125.0000000000;InpForceCloseSecondsAfterEvent=600;}
if(kind=="CPI") {InpPlacementLeadSeconds=45;NPX_Anchor=2;InpEntryOffsetPrice=37.5000000000;InpStopLossPrice=12.5000000000;NPX_TPR=0.0;InpTrailStartR=1.5;InpTrailDistancePrice=25.0000000000;InpForceCloseSecondsAfterEvent=60;}
if(kind=="FOMC") {InpPlacementLeadSeconds=90;NPX_Anchor=2;InpEntryOffsetPrice=6.2500000000;InpStopLossPrice=12.5000000000;NPX_TPR=0.0;InpTrailStartR=1.0;InpTrailDistancePrice=37.5000000000;InpForceCloseSecondsAfterEvent=300;}
}
