...
if(kind=="NFP") {InpPlacementLeadSeconds=90;NPX_Anchor=2;InpEntryOffsetPrice=0.0002000000;InpStopLossPrice=0.0001000000;NPX_TPR=0.0;InpTrailStartR=100000;InpTrailDistancePrice=0.0020000000;InpForceCloseSecondsAfterEvent=300;}
if(kind=="CPI") {InpPlacementLeadSeconds=60;NPX_Anchor=0;InpEntryOffsetPrice=0.0001000000;InpStopLossPrice=0.0002000000;NPX_TPR=0.0;InpTrailStartR=3.0;InpTrailDistancePrice=0.0004000000;InpForceCloseSecondsAfterEvent=60;}
if(kind=="FOMC") {InpPlacementLeadSeconds=10;NPX_Anchor=2;InpEntryOffsetPrice=0.0001000000;InpStopLossPrice=0.0001000000;NPX_TPR=0.0;InpTrailStartR=100000;InpTrailDistancePrice=0.0003000000;InpForceCloseSecondsAfterEvent=60;}
}
