...
$expertFolder='AAA Research\US100 NY VWAP Bounce'
$expertName='US100 NY VWAP Bounce EA'
$expertRoot=Join-Path $testerRoot ('MQL5\Experts\'+$expertFolder)
$setRoot=Join-Path $testerRoot 'MQL5\Profiles\Tester'
$configRoot=Join-Path $testerRoot 'backtest-configs\us100-ny-vwap-bounce-20260826'
$testerReports=Join-Path $testerRoot 'reports\us100-ny-vwap-bounce-20260826'
...
$selected='SCREEN SELECTED - USTEC M5 - ORB15 VWAP EMA ATR025 RR2 - 1pct.set'
$literal='LITERAL - USTEC M5 - ORB30 directional VWAP rejection extreme - 1pct.set'
...
$cases=@(
    ...
    [pscustomobject]@{Slug='selected-one-year-every-tick';Set=$selected;From='2025.08.26';To='2026.08.25';Model=0;Segment='One Year'},
    ...
    [pscustomobject]@{Slug='literal-locked-real-ticks';Set=$literal;From='2025.07.01';To='2026.08.25';Model=4;Segment='Locked'},
    [pscustomobject]@{Slug='literal-locked-every-tick';Set=$literal;From='2025.07.01';To='2026.08.25';Model=0;Segment='Locked'},
    [pscustomobject]@{Slug='literal-one-year-every-tick';Set=$literal;From='2025.08.26';To='2026.08.25';Model=0;Segment='One Year'}
)
if($CaseRegex){
...
foreach($case in $cases){
    ...
    $relativeReport='reports\us100-ny-vwap-bounce-20260826\'+$case.Slug+'.htm'
    $config=@"
[Common]
Login=472334559
