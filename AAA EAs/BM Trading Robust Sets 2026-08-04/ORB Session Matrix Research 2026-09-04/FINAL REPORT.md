...
| London 07:00 UTC | M1 / OR30 / 1.5R / opposite-b10-max2.5 / none / 90m | -5.09% | 0.95 | 43.23% | 19.57% | 192 | -1.41 | -0.23 | -28.62% | 33.74% | +51.47% | 1.15 |
| New York 09:30 local | M30 / OR30 / 1.5R / opposite-b10-max2 / be05 / 180m | +2.44% | 3.04 | 45.45% | 2.64% | 11 | 2.82 | 0.90 | +0.04% | 1.56% | +13.41% | 2.36 |
| London/New York overlap 13:00 UTC | M30 / OR5 / 1.0R / opposite-b05-max1.5 / be05 / 180m | +5.19% | 2.15 | 37.04% | 3.96% | 27 | 27.29 | 1.27 | -0.77% | 4.94% | +27.51% | 2.45 |

Existing comparator: Current active XAU Dynamic 50/20 ORB — +12.74% return, PF 1.86, win 44.90%, DD 6.22%, 49 trades.
...
| London/New York overlap 13:00 UTC | M15 / OR15 / 3.0R / signal-b10-max2.5 / be05 / 120m | -12.84% | 0.78 | 18.99% | 16.30% | 158 | -5.00 | -0.77 | -31.18% | 33.64% | +15.52% | 1.10 |
