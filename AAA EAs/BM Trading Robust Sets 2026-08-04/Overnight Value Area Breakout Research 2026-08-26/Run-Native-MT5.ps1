...
$expertFolder='AAA Research\US100 Overnight Value Area'
$expertName='US100 Overnight Value Area Breakout EA'
$expertRoot=Join-Path $testerRoot ('MQL5\Experts\'+$expertFolder)
$setRoot=Join-Path $testerRoot 'MQL5\Profiles\Tester'
$configRoot=Join-Path $testerRoot 'backtest-configs\us100-overnight-va-20260826'
$testerReports=Join-Path $testerRoot 'reports\us100-overnight-va-20260826'
...
$selected='SCREEN SELECTED - USTEC M15 - VA70 B64 Retest ATR RR15 - 1pct.set'
$literal='LITERAL - USTEC M15 - first close VA70 signal stop RR05 - 1pct.set'
...
$cases=@(
    ...
    [pscustomobject]@{Slug='selected-locked-real-ticks';Set=$selected;From='2025.07.01';To='2026.08.25';Model=4;Segment='Locked'},
    [pscustomobject]@{Slug='selected-one-year-real-ticks';Set=$selected;From='2025.08.26';To='2026.08.25';Model=4;Segment='One Year'},
    [pscustomobject]@{Slug='selected-one-year-every-tick';Set=$selected;From='2025.08.26';To='2026.08.25';Model=0;Segment='One Year Every Tick'},
    ...
    [pscustomobject]@{Slug='literal-one-year-real-ticks';Set=$literal;From='2025.08.26';To='2026.08.25';Model=4;Segment='One Year'},
    [pscustomobject]@{Slug='literal-one-year-every-tick';Set=$literal;From='2025.08.26';To='2026.08.25';Model=0;Segment='One Year Every Tick'}
)
if($CaseRegex){
...
foreach($case in $cases){
    ...
    $relativeReport='reports\us100-overnight-va-20260826\'+$case.Slug+'.htm'
    $config=@"
[Common]
Login=472334559
