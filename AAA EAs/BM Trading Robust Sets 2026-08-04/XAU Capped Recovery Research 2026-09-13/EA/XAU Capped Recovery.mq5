...
input int InpMaxLegs=3;
input double InpStep=10.0;
input bool InpATRStep=false;
input double InpATRMultiple=1.0;
input double InpBasketProfit=20.0;
input bool InpOriginalExit=false;
input double InpBasketLoss=60.0;
input double InpDailyLoss=90.0;
input double InpDailyProfit=60.0;
input double InpCommissionPerLot=5.50;
input int InpLeverageCap=2000;
input bool InpStopAtDouble=false;
input long InpMagic=84913201;
CTrade trade;
