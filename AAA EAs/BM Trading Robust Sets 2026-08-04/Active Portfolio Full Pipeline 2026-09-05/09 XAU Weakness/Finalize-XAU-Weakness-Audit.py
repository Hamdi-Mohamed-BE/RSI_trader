...
CASES = [
    "legacy-standard-dynamic5020",
    "selected-m30-rr400-dynamic5020",
    "selected-m30-rr400-safe5020",
    "selected-m30-rr400-none",
    "selected-m30-rr400-native150",
]
LABELS = {
    "legacy-standard-dynamic5020": "Previous M15 / 2R Dynamic 50/20",
    "selected-m30-rr400-dynamic5020": "Recommended M30 / 4R Dynamic 50/20",
    "selected-m30-rr400-safe5020": "Full Safe M30 / 4R Dynamic 50/20",
    "selected-m30-rr400-none": "M30 / 4R no management",
    "selected-m30-rr400-native150": "M30 / 4R native trailing",
}
COLORS = {
    "legacy-standard-dynamic5020": "#94a3b8",
    "selected-m30-rr400-dynamic5020": "#6ee7b7",
    "selected-m30-rr400-safe5020": "#38bdf8",
    "selected-m30-rr400-none": "#fbbf24",
    "selected-m30-rr400-native150": "#f97316",
}
...
def make_chart(development, locked, three, balances, monte, fans) -> Path:
    ...
    ax.set_xticks(x, ["Previous", "Recommended", "Full Safe", "No management", "Native trail"])
    ax.set_ylabel("Return (%)")
    ax.set_title("Stability across test windows", loc="left", fontweight="bold")
    ax.legend(fontsize=8, frameon=False)

    recommended = "selected-m30-rr400-dynamic5020"
    ax = axes[1, 0]
    ...
    ax.set_title("Recommended M30 / 4R Dynamic 50/20 — 10,000 paths", loc="left", fontweight="bold")
    ax.set_ylabel("USD")
    ax.set_xlabel("Calendar days")
    ax.legend(fontsize=8, frameon=False)
    ...
    fig.suptitle("XAU Weakness — final optimization decision", fontsize=18, fontweight="bold", y=0.99)
    fig.text(
        0.5,
        0.955,
    ...
    output = ROOT / "XAU Weakness - FINAL DECISION AND MONTE CARLO.png"
...
def main() -> None:
    ...
    markets = []
    for case in ("selected-market-xau-m30-rr400", "selected-market-xag-m30-rr400", "selected-market-us30-m30-rr400", "selected-market-us100-m30-rr400", "selected-market-btc-m30-rr400", "selected-market-gbpjpy-m30-rr400"):
    ...
    report = f"""# Step 8 — XAU Weakness full optimization
...
"""
    report_path = ROOT / "STEP 8 - XAU WEAKNESS FULL OPTIMIZATION.md"
