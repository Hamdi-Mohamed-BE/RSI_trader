...
$manifestPath=Join-Path $testerRoot 'backtest-configs\active-bat-20260812\manifest.json'
...
Write-Host ("Completed {0} active-BAT tests." -f $cases.Count) -ForegroundColor Green
