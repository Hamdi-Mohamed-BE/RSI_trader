...
declare function generateUrls({ instrument, timeframe, priceType, startDate, endDate, nowDate }: GenerateUrlsInput): string[];
...
declare function processData({ requestedTimeframe, bufferObjects, priceType, volumes, volumeUnits, ignoreFlats }: ProcessDataInput): ProcessDataOutput;
